...
INSERT INTO bronx.categories (
	...
	'Education',
	32000000000.00,
	'<p>The Department of Education (DOE) funds public and charter schools, prekindergarten programs, and afterschool care (sports, music, other educational programming).</p>'
);
...
INSERT INTO bronx.categories (
	...
	'CUNY',
	 1000000000.00,
	 '<p>In addition to DOE spending, education spending also includes funding for the system of 25 colleges across the City that make up City University of New York (CUNY).</p>'
);
